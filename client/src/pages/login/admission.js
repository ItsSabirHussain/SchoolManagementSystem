...
class Admission extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      email: "admin@schoolmanagementsystem.com",
      password: "password",
    };
  ...
  doLogin(e) {
    e.preventDefault();
    localStorage.setItem("adminID", "authenticated");
      ...
      <div className="auth-page">
        <Container>
          <Widget
            ...
            title={<h3 className="mt-0">Admission Officer Login</h3>}
          >
