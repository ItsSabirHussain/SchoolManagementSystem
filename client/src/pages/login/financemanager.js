...
class FinanceManager extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      email: "finance@schoolmanagementsystem.com",
      password: "password",
    };
  ...
  doLogin(e) {
    e.preventDefault();
    localStorage.setItem("financeID", "authenticated");
    this.props.history.push("/financemanager");
  }
      ...
      <div className="auth-page">
        <Container>
          <Widget
            ...
            title={<h3 className="mt-0">Finance Manager Login</h3>}
          >
