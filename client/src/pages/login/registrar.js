...
class Registrar extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      email: "registrar@schoolmanagementsystem.com",
      password: "password",
    };
  ...
  doLogin(e) {
    e.preventDefault();
    localStorage.setItem("registrarID", "authenticated");
      ...
      <div className="auth-page">
        <Container>
          <Widget
            ...
            title={<h3 className="mt-0">Registrar Login</h3>}
          >
